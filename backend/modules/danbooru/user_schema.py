"""Danbooru-owned tables and additive identity migrations in the shared user DB."""
...
def migrate_user_tables(conn: sqlite3.Connection, data_db_path: Path, data_root: Path) -> None:
