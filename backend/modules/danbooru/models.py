...
# Files has a response model with this name too. Preserve the established
# qualified OpenAPI component name while the class is owned by Danbooru.
FolderRelocateResult.__module__ = "models"
FolderRelocateResult.model_rebuild(force=True)
