<script lang="ts">
  ...
  import { type ArtistFollowInfo } from '../apiTypes';
  import { activeCollectionId, artistFocusRequest, artistFollowRefreshToken, artistNotificationIntervalMinutes, selectedImageId, viewMode } from '../stores';
