...
const contribution: SettingsContribution = {
  ...
  searchItems: [
    ...
    { id: 'import-pipeline', section: 'library', label: 'Library update', description: 'Update local files, fetch missing tags and retry unfinished work.', keywords: ['import', 'rescan', 'sync', 'metadata', 'retry', 'logs'] },
    ...
    { id: 'refresh-tags', section: 'maintenance', label: 'Refresh existing tags', description: 'Fetch current Danbooru metadata and archive replaced sidecars.', keywords: ['network', 'refresh', 'tags', 'archive'] },
