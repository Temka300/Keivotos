...
<button type="button" role="switch" aria-label={label} aria-checked={checked} {disabled} on:click class="settings-switch" class:checked>
  <span></span>
</button>
<style>
  ...
  @media(prefers-reduced-motion:reduce){span,.settings-switch{transition:none}}
</style>
